$(function() {
    ...
    var config = {
    apiKey: "AIzaSyCmcq1zbNd_1N-iq4dfzTJWUS9uHBlPiuA",
    authDomain: "collab-and-edit.firebaseapp.com",
    databaseURL: "https://collab-and-edit.firebaseio.com",
    projectId: "collab-and-edit",
    storageBucket: "collab-and-edit.appspot.com",
    messagingSenderId: "626300515415"
  };
    ...
    currentEditorValue.child("content").once("value", function (contentRef) {
        ...
        if (val === null) {
            ...
            // ...with this content:
            val = "/* Welcome to Collab and Edit! */";
